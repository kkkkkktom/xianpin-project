...
const addCart=()=>{
  if(skuObj.skuId){
   cartStore.addCart({
            ...
            picture: detailData.value.mainPictures[0],  //图片
            price: detailData.value.price,  //最新价格
            count: count.value,  //商品数量
            skuId: skuObj.skuId,
            attrsText: skuObj.specsText,  //商品规格文本
            selected: false  //商品是否选中
   })
  }else{
    ...
    <div class="container" v-if="detailData.details">
      <div class="bread-container">
        <el-breadcrumb separator=">">
          ...
          <el-breadcrumb-item :to="{ path: `/category/sub/${detailData.categories[0].id}` }">{{ detailData.categories[0].name }}
          </el-breadcrumb-item>
